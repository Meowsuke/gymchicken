const Homepage = async () => {
  return (
    <>
      <section className="flex flex-col items-center justify-center min-h-screen px-6 text-center bg-gray-50">
        ...
        <div className="grid gap-6 sm:grid-cols-3 max-w-3xl">
          <div className="p-4 bg-white shadow rounded-lg">
            <h3 className="font-semibold mb-2 text-gray-800">カレンダー管理</h3>
          ...
          <div className="p-4 bg-white shadow rounded-lg">
            <h3 className="font-semibold mb-2 text-gray-800">進捗の可視化</h3>
            <p className="text-sm text-gray-600">
              過去のデータを見返して、成長を実感。
              継続のモチベーションを高めます。
            </p>
